...
public class TC1verifyTest {
  ...
  public void tC1verify() {
    ...
    driver.findElement(By.cssSelector("*[data-test=\"password\"]")).sendKeys("secret_sauceabc");
    ...
    driver.findElement(By.cssSelector("*[data-test=\"username\"]")).click();
    {
      WebElement element = driver.findElement(By.cssSelector("*[data-test=\"username\"]"));
      Actions builder = new Actions(driver);
      builder.doubleClick(element).perform();
    }
    driver.findElement(By.cssSelector("*[data-test=\"username\"]")).sendKeys("standard_user");
    ...
    driver.findElement(By.cssSelector(".app_logo")).click();
    driver.findElement(By.cssSelector(".app_logo")).click();
    assertThat(driver.findElement(By.cssSelector(".app_logo")).getText(), is("Swag Labs"));
    driver.close();
  }
}
